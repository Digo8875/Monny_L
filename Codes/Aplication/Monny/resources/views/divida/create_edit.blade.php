            ...
            <div class='card col-lg-12'>
                <div class='card-header row'>
					...
					<div class='col-lg-6 offset-lg-3 rounded'>
		    			<h1>
		    			    {{((isset($obj->id)) ? 'Editar Dívida' : 'Nova Dívida')}}
		    			</h1>
		    		</div>
                </div>
                ...
                <div class='card-body'>
                    @if(!(isset($obj->id)))
					{{ Form::open(['url' => 'divida', 'method' => 'POST']) }}
					@else
					{{ Form::open(['url' => 'divida/'.$obj->id.'', 'method' => 'PATCH']) }}
					@endif
						...
						@endif
					  	...
					  	<div class='form-group row'>
					  		{{ Form::label('nome', 'Nome da Dívida:', ['class' => 'col-md-4 col-form-label text-md-right']) }}
                        ...
                        <div class='form-group row'>
					  		{{ Form::label('descricao', 'Descrição da Dívida:', ['class' => 'col-md-4 col-form-label text-md-right']) }}
                        ...
                        <div class='form-group row'>
					  		{{ Form::label('tipo_divida', 'Selecione o Tipo da Dívida:', ['class' => 'col-md-4 col-form-label text-md-right']) }}

                            <div class='col-md-6'>
                            	{{ Form::select('tipo_divida', ['' => 'Selecione', '2' => 'Dívida a Pagar', '3' => 'Dívida a Receber'], $obj->tipo, ['class' => 'form-control', 'id' => 'tipo_divida']) }}

                            	@if($errors->has('tipo_divida'))
									<span class='alert alert-danger'>
										<strong>{{ $errors->first('tipo_divida') }}</strong>
									</span>
								@endif
                            </div>
                        </div>
                        ...
                        <div class='form-group row'>
					  		{{ Form::label('valor', 'Valor da Dívida:', ['class' => 'col-md-4 col-form-label text-md-right']) }}
						...
						<div class='form-group row'>
							...
							@endphp
					  		...
					  		{{ Form::label('ativo', 'Dívida Ativa', ['class' => 'col-md-4 col-form-label text-md-right']) }}
