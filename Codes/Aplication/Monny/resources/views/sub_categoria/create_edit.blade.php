            ...
            <div class='card col-lg-12'>
                <div class='card-header row'>
					...
					<div class='col-lg-6 offset-lg-3 rounded'>
		    			<h1>
		    			    {{((isset($obj->id)) ? 'Editar Subcategoria' : 'Nova Subcategoria')}}
		    			</h1>
		    		</div>
                </div>
                ...
                <div class='card-body'>
                    @if(!(isset($obj->id)))
					{{ Form::open(['url' => 'sub_categoria', 'method' => 'POST']) }}
					@else
					{{ Form::open(['url' => 'sub_categoria/'.$obj->id.'', 'method' => 'PATCH']) }}
					@endif
						...
						{{ Form::hidden('id', $obj->id) }}
					  	...
					  	<div class='form-group row'>
					  		{{ Form::label('nome', 'Nome da Subcategoria:', ['class' => 'col-md-4 col-form-label text-md-right']) }}
                        ...
                        <div class='form-group row'>
					  		{{ Form::label('categoria', 'Selecione a Categoria:', ['class' => 'col-md-4 col-form-label text-md-right']) }}

                            <div class='col-md-6'>
                            	{{ Form::select('categoria_id', $lista_categorias, $obj->categoria_id, ['class' => 'form-control', 'id' => 'categoria_id']) }}
						...
						<div class='form-group row'>
							...
							@endphp
					  		...
					  		{{ Form::label('ativo', 'Subcategoria Ativa', ['class' => 'col-md-4 col-form-label text-md-right']) }}
